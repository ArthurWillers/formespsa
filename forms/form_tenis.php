...
if (isset($_POST['submitTenis'])) {
    if ($currentStep === 'A_feminino') {
        ...
        header('Location: form_tenis.php');
        exit;
...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg bg-body-secondary sticky-top">
        <div class="container-fluid">
            ...
            <span class="ms-auto">
                Se enviar sem preencher nada, será considerado que não haverá atleta inscrito nesta categoria.
            </span>
            <div class="ms-auto">
    ...
    <div class="container my-5" style="max-width: 800px;">
        <div class="card shadow p-4 bg-white border-0">
            ...
            <?php if ($currentStep === 'A_feminino'): ?>
                <h3 class="text-center">Tênis de Mesa – Categoria A – Feminino</h3>
                <form method="post" class="cat-a">
                    ...
                    <div class="col-12 text-center">
                        <button type="submit" name="submitTenis" class="btn btn-primary submit-button">Enviar Categoria A Feminino</button>
                    </div>
                    <?php include '../assets/modal_reset.php'; ?>
                </form>

            <?php elseif ($currentStep === 'A_masculino'): ?>
                <h3 class="text-center">Tênis de Mesa – Categoria A – Masculino</h3>
                <form method="post" class="cat-a">
                    <?php for ($i = 1; $i <= 2; $i++): ?>
                        <div class="mb-3">
                            <label>Nome - Atleta <?php echo $i; ?></label>
                    ...
                    <?php endfor; ?>
                    <div class="col-12 text-center">
                        <button type="submit" name="submitTenis" class="btn btn-primary submit-button">Enviar Categoria A Masculino</button>
                    </div>
                    <?php include '../assets/modal_reset.php'; ?>
                </form>

            <?php elseif ($currentStep === 'B_feminino'): ?>
                <h3 class="text-center">Tênis de Mesa – Categoria B – Feminino</h3>
                <form method="post" class="cat-b">
                    ...
                    <?php endfor; ?>
                    <div class="col-12 text-center">
                        <button type="submit" name="submitTenis" class="btn btn-primary submit-button">Enviar Categoria B Feminino</button>
                    </div>
                    <?php include '../assets/modal_reset.php'; ?>
                </form>

            <?php elseif ($currentStep === 'B_masculino'): ?>
                <h3 class="text-center">Tênis de Mesa – Categoria B – Masculino</h3>
                <form method="post" class="cat-b">
                    <?php for ($i = 1; $i <= 2; $i++): ?>
                        <div class="mb-3">
                            <label>Nome - Atleta <?php echo $i; ?></label>
                    ...
                    <?php endfor; ?>
                    <div class="col-12 text-center">
                        <button type="submit" name="submitTenis" class="btn btn-primary submit-button">Enviar Categoria B Masculino</button>
                    </div>
                    <?php include '../assets/modal_reset.php'; ?>
                </form>
            <?php endif; ?>
